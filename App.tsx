  ...
  return (
    <div className="flex flex-col h-screen w-full bg-[#030712] font-sans text-white overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* 1. PLAYER CASTER (ÚNICO PLAYER ATIVO) */}
        <section className="shrink-0">
          <CasterPlayer />
        </section>

        {/* 2. CARROSSEL (PREENCHE O RESTANTE DA TELA) */}
        <section className="flex-1 w-full relative min-h-0">
          <HeroCarousel images={config.images} />
        </section>

        {/* Footer Sutil */}
        <footer className="shrink-0 py-4 px-4 bg-gradient-to-t from-black to-transparent">
          <p className="text-[7px] font-black uppercase tracking-[0.6em] text-center opacity-20 pointer-events-none">
